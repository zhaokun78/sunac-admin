	...
	<div>
		<div class="step_container">
			<div v-if="orderData.order_id && orderData.state != '已取消'" class="dflex">
				...
				<div class="step dflex_d_c dflex_c pos_r" :class="active >= 5 ? 'active' : ''">
					<div class="circle dflex_c"><i class="iconfont" :class="active >= 5 ? 'iconwancheng' : 'iconshijian'"></i></div>
				...
				<div>
					<div class="dflex table">
						...
						<div class="table_content padding_l_10">
							...
							<span class="copy" v-if="orderData.order_member_openid" @click="copy(orderData.order_member_openid)">复制</span>
						</div>
					</div>
					<div class="dflex table">
						...
						<div class="table_content padding_l_10 border_top_none">
							<div class="dflex_vertical_c pos_a">
								<img class="headimg" :src="orderData.order_member_headimg || '/static/img/default.jpg'" />
					...
					<div class="dflex table">
						...
						<div class="table_content padding_l_10">
							...
							<span class="copy" v-if="orderData.order_express_no" @click="copy(orderData.order_express_no)">复制</span>
						</div>
					</div>
					<div class="dflex table">
		...
		<div class="detail pos_r margin_b_20">
			<el-tabs v-model="tab" @tab-click="cutTabs">
				<el-tab-pane label="收货人" name="consignee"><consignee :data="orderData"></consignee></el-tab-pane>
				<el-tab-pane label="商品" name="goods"><goods v-if="tab == 'goods'"></goods></el-tab-pane>
				<el-tab-pane label="日志" name="log"><log v-if="tab == 'log'"></log></el-tab-pane>
				<el-tab-pane label="评价" name="evaluate"><evaluate v-if="tab == 'evaluate'"></evaluate></el-tab-pane>
				<el-tab-pane label="支付" name="pay"><pay v-if="tab == 'pay'"></pay></el-tab-pane>
			</el-tabs>
